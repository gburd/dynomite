...
[`docs/dynvec/fold-into-redis-path.md`](DYN_SRC_BASE/docs/dynvec/fold-into-redis-path.md)
...
- **Vector design:** [`docs/dynvec/architecture.md`](DYN_SRC_BASE/docs/dynvec/architecture.md)
  documents the dynvec engine that backs HSET indexing, HNSW graph
  layout, and the encoding/distance modules.
- **Text design:** [`docs/dyntext/design.md`](DYN_SRC_BASE/docs/dyntext/design.md)
