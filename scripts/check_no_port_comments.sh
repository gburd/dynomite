...
PATTERN='ported from|port of|matches dyn_|matches the C|originally in dyn_|from twemproxy|[Mm]irrors `?dyn_|[Mm]irrors the `?dyn_|[Mm]irror[s]? .* dyn_|C reference engine|dyn_[a-z_]+\.c\b'
