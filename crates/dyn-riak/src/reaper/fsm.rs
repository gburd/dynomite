...
///
/// ```
/// use dyn_riak::reaper::ReaperConfig;
///
...
impl ReaperHandler {
    ...
    ///
    /// ```
    /// use dyn_riak::reaper::ReaperHandler;
    ...
    ///
    /// ```
    /// use dyn_riak::reaper::{ReaperConfig, ReaperHandler};
    ...
    /// use dyn_riak::reaper::{KeyKind, ReaperConfig, ReaperHandler, ScannedKey};
    ///
